// Your existing catalog function, with ONE change: the key now comes from an
// environment variable instead of being hardcoded. Behavior is otherwise
// identical. Paste this over the CONTENTS of your current catalog file —
// keep that file's existing name so its URL doesn't change.

const TMDB_API_KEY = process.env.TMDB_API_KEY; // <-- was a hardcoded key; now safe
